...
Поле `price` в датасете — это не цена в реальной валюте, а нормализованное (отмасштабированное) значение, Поэтому везде в проекте это поле называется **Price Index**. сравнения между категориями и динамика во времени остаются валидными.
